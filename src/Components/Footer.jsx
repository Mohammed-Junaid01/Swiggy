...
export default function Footer() {
  return (
    ...
    <div className="bg-[#02060c]">
        <Container>
            <footer className='md:px-[100px] md:py-[80px] px-[0px] py-[0px] text-[#ffffff99]'>
...
<div className='text-2xl font-bold text-[#ffffffeb]'>Swiggy</div>
                    </div>
<div>© 2024 Bundl <br /> Technologies Pvt. Ltd</div>
                </div>
                <div>
                    <div className="text-xl text-[#ffffffeb] font-bold p-2">Company</div>
                    <div className="p-1">About</div>
                    <div className="p-1">Careers</div>
                    <div className="p-1">Team</div>
                    <div className="p-1">Swiggy One</div>
                    <div className="p-1">Swiggy Instamart</div>
                    <div className="p-1">Swiggy Genie</div>
                </div>
                <div>
                <div className="text-xl text-[#ffffffeb] font-bold p-2">Contact us</div>
                <div className="p-1">Help & Support</div>
                <div className="p-1">Partner with us</div>
                <div className="p-1">Ride with us</div>
                <div>
                <div className="text-xl text-[#ffffffeb] font-bold p-2 mt-5">Legal</div>
                <div className="p-1">Terms & Conditions</div>
                <div className="p-1">Cookie Policy</div>
                <div className="p-1">Privacy Policy</div>
                <div className="p-1">Investor Relations</div>
                </div>
                </div>
                <div>
                <div className="text-xl text-[#ffffffeb] font-bold p-2">We deliver to:</div>
                <div className="p-1">Bangalore</div>
                <div className="p-1">Gurgaon</div>
                <div className="p-1">Hyderabad</div>
                <div className="p-1">Delhi</div>
                <div className="p-1">Mumbai</div>
                <div className="p-1">Pune</div>
                </div>
                </div>
            </footer>
        </Container>
